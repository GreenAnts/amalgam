...
export function getIntersectionByCoords(board, coords) {
    return board.intersections.find(intersection => intersection.coords[0] === coords[0] && intersection.coords[1] === coords[1]) || null;
}
/**
...
export function placePiece(board, coords, pieceId) {
    ...
    const intersection = newBoard.intersections.find(int => int.coords[0] === coords[0] && int.coords[1] === coords[1]);
    if (intersection) {
...
export function movePiece(board, fromCoords, toCoords) {
    const newBoard = cloneBoard(board);
    const fromIntersection = newBoard.intersections.find(int => int.coords[0] === fromCoords[0] && int.coords[1] === fromCoords[1]);
    const toIntersection = newBoard.intersections.find(int => int.coords[0] === toCoords[0] && int.coords[1] === toCoords[1]);
 ...
 */
export function getPlayerPieces(state, playerId) {
 ...
 */
export function countPlayerPieces(state, playerId) {
...
export function isGoldenLineIntersection(board, coords) {
    return board.goldenLineIntersections.some(glCoords => glCoords[0] === coords[0] && glCoords[1] === coords[1]);
}
/**
