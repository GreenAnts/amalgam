 ...
 * @returns Validation result
 */
export function validateStandardMovement(state: GameState, move: Move): MoveResult {
 ...
 * @returns Validation result
 */
export function validateNexusMovement(state: GameState, move: Move): MoveResult {
 ...
 * @returns Validation result
 */
export function validatePortalSwap(state: GameState, move: Move): MoveResult {
 ...
 * @returns Validation result
 */
export function validatePortalLineMovement(state: GameState, move: Move): MoveResult {
 ...
 * @returns Validation result
 */
export function validatePortalStandardMovement(state: GameState, move: Move): MoveResult {
 ...
 * @returns Validation result
 */
export function validatePortalPhasing(state: GameState, move: Move): MoveResult {
 ...
 */
function applySetupMove(state: GameState, move: Move, pieceDefs: PieceDefinitions): MoveResult {
 ...
 */
function applyGameplayMove(state: GameState, move: Move, pieceDefs: PieceDefinitions): MoveResult {
 ...
 */
export function executeCombat(state: GameState, movedPiece: Piece): string[] {
 ...
 * @returns Array of destroyed piece IDs
 */
export function executeStandardCombat(state: GameState, attackingPiece: Piece): string[] {
 ...
 * @returns Array of destroyed piece IDs
 */
export function executePortalCombat(state: GameState, attackingPortal: Piece): string[] {
 ...
 * @returns Array of destroyed piece IDs
 */
export function executeVoidCombat(state: GameState, attackingVoid: Piece): string[] {
 ...
 */
export function detectFormations(state: GameState, movedPiece: Piece): Formation[] {
 ...
 * @returns Array of destroyed piece IDs
 */
export function executeFireball(state: GameState, formation: Formation, direction: Vector2): string[] {
 ...
 * @returns Array of destroyed piece IDs
 */
export function executeTidalWave(state: GameState, formation: Formation, direction: Vector2): string[] {
 ...
 * @returns Array of destroyed piece IDs
 */
export function executeSap(state: GameState, formation: Formation): string[] {
 ...
 */
export function executeLaunch(state: GameState, formation: Formation, launchedPiece: Piece, destination: Vector2): string[] {
 ...
 */
export function checkVictoryConditions(state: GameState): { winner: PlayerId; victoryType: string } | null {
 ...
 */
export function checkObjectiveVictory(state: GameState): { winner: PlayerId; victoryType: string } | null {
 ...
 */
export function checkEliminationVictory(state: GameState): { winner: PlayerId; victoryType: string } | null {
 ...
 */
export function manhattanDistance(coords1: Vector2, coords2: Vector2): number {
 ...
 */
export function euclideanDistance(coords1: Vector2, coords2: Vector2): number {
