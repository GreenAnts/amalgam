...
import { ParticleSystem, ParticlePresets, ParticlePresetName, ParticleConfig } from './particle-system.js';
...
export class AbilityAnimationManager {
  private animations: Map<string, AbilityAnimation> = new Map();
  ...
  startAbilityAnimation(
    abilityId: string, 
    abilityType: ParticlePresetName, 
    config: AbilityAnimationConfig
  ): void {
   ...
   */
  stopAbilityAnimation(abilityId: string): void {
   ...
   */
  isAnimationActive(abilityId: string): boolean {
...
export function createTargetedAbilityAnimation(
  manager: AbilityAnimationManager,
  abilityType: ParticlePresetName,
  targetX: number,
  targetY: number,
  ...
  const config: AbilityAnimationConfig = {
